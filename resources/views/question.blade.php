...
<body class="d-flex flex-column h-100">
                                    ...
                                    <div class="carousel-item @if ($loop->first) active @endif">
                                        <div class="d-flex align-items-baseline">
                                            <div class="order-1 p-4 ">
                                                ...
                                                @if ($loop->last)
                                                    <button class="mt-4 d-block w-100 btn btn-outline-dark"
                                                        type="submit">
    ...
    <footer class="footer mt-auto py-2 bg-light text-center">
        <div class="container">
            <span class="fw-light text-muted">Developed by <a class="text-secondary fw-normal"
                    href="https://github.com/mnborges/wcquiz">@mnborges</a></span>
        </div>
    </footer>
    ...
    <script>
        // Configuration of bootstrap carousel
        ...
        /* Event triggers after carousel slide transitions.
         *  Callback gets number of current active slide, use it to calculate progress percentage
         *  then change progress bar attributes accordingly.
         */
